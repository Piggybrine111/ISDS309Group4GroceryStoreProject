...
{
    public partial class Tab_Dairy : Form
    {
        public Tab_Dairy()
        {
            InitializeComponent();
        ...
        private void Tab_Dairy_Load(object sender, EventArgs e)
        {
        ...
        private void Tab_Dairy_FormClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
        }
    }
